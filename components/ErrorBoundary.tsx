...
// Fix: Extend Component directly to ensure state, props, and setState are correctly inherited and recognized by the compiler
export class ErrorBoundary extends Component<Props, State> {
  ...
  public render() {
      ...
      return (
        <div className="w-full h-full flex flex-col items-center justify-center bg-slate-900/50 border-2 border-red-700/50 p-8 rounded-lg text-center">
            ...
            <p className="text-slate-400 text-sm">
             ...
             <button
                // Fix: properly typed setState is available on Component instances
    ...
    // Fix: properly typed props and children are available on Component instances
